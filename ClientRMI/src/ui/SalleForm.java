...
public class SalleForm extends javax.swing.JInternalFrame {
    ...
    private SalleForm() {
        try {
            initComponents();
            daoo = (IDao<Salle>) Naming.lookup("rmi://" + Config.ip + ":" + Config.port + "/daoo");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(bouttonModifier, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tableSalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableSalleMouseClicked
        ...
        if (selectedRow != -1) {
            try {
                ...
                txtCode.setText(daoo.findById(id).getCode());
            } catch (RemoteException ex) {
                Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private int countMachinesInSalle() throws RemoteException {
        Salle salle = daoo.findById(id);
        int count = 0;
        if (salle != null) {
            for (Machine machine : dao1.findAll()) {
